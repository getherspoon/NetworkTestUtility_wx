...
${OBJECTDIR}/NetworkDlgMulticastTab.o: NetworkDlgMulticastTab.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DBOOST_DISABLE_ASSERTS -DBOOST_ENABLE_ASSERT_HANDLER -DBOOST_THREAD_USE_LIB -DNO_MFC -D_DEBUG -D__WXDEBUG__ -D__WXMSW__ -I../../Third_Party/Libraries/wxWidgets/wxWidgets-2.8.12/build-static-debug-gcc4.7.2/lib/wx/include/msw-ansi-debug-static-2.8 -I../../Third_Party/Libraries/wxWidgets/wxWidgets-2.8.12/include -I../../Third_Party/Libraries/wxWidgets/wxWidgets-2.8.12/contrib/include -I../../Third_Party/Libraries/Boost/include/boost_1_53_0 -I../../SENTEL/Libraries/EthernetComms/include -I../../SENTEL/Libraries/EthernetComms/include/BoostAsioConnections -MMD -MP -MF $@.d -o ${OBJECTDIR}/NetworkDlgMulticastTab.o NetworkDlgMulticastTab.cpp
