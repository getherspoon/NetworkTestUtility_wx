...
# Subprojects
.build-subprojects:
	cd ../SENTEL_EthernetCommsLibrary && ${MAKE}  -f Makefile CONF=Debug_MinGW_Static
...
# Subprojects
.clean-subprojects:
	cd ../SENTEL_EthernetCommsLibrary && ${MAKE}  -f Makefile CONF=Debug_MinGW_Static clean
